...
<div class="p-6">
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold">Enregistrer une présence</h1>
            <a href="{{ route('admin.attendance.index') }}" class="text-gray-600 hover:text-gray-900">✕</a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 class="text-lg font-bold mb-4">📊 Présences d'aujourd'hui</h2>
...
async function loadMembers() {
    ...
    searchInput.addEventListener('input', async function(e) {
        ...
        try {
            const response = await fetch('{{ route("admin.api.members.search") }}?q=' + encodeURIComponent(query));
