...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg p-6">
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white p-8 rounded-xl border-2 border-dashed border-gray-200 mb-6">
            <div class="text-center">
                <div class="inline-block p-6 bg-white rounded-lg shadow-md">
                    <div class="text-xl font-semibold text-gray-800">QR Codes désactivés</div>
                    <p class="text-sm text-gray-500 mt-2">Les QR codes ont été remplacés par un bouton d'enregistrement de présence pour tout le projet.</p>
                </div>
                <p class="text-gray-500 text-sm mt-4">
                    Utilisez les outils de présences pour enregistrer les entrées/sorties des membres.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a href="{{ route('admin.attendance.index') }}" class="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all duration-200 font-medium text-center">
