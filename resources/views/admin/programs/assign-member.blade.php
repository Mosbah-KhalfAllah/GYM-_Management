...
@section('title', 'Assigner un programme - Admin')
...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.members.show', $member->id) }}" class="px-4 py-2 border rounded-lg hover:bg-gray-50">
                        ...
                        @foreach($availablePrograms as $program)
                            <div class="border rounded-lg p-4 hover:bg-gray-50 transition">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        ...
                                        <div class="grid grid-cols-3 gap-4 mt-3 text-sm">
                                            <div>
                                                ...
                                                <p class="font-semibold">{{ $program->coach->full_name() }}</p>
                                            </div>
                                            <div>
                                    ...
                                    <form action="{{ route('admin.programs.assignMember', $member->id) }}" method="POST" class="ml-4 h-fit">
                                        @csrf
